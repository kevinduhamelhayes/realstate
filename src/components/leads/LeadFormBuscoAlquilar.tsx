...
export default function LeadFormBuscoAlquilar() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto mt-10 p-6 rounded-lg bg-white shadow">
      <h1 className="text-2xl font-bold mb-6 text-primary">Formulario: Busco alquilar una propiedad</h1>
      ...
      <div className="mb-4">
        <label className="block mb-1 font-medium text-gray-700">Rango de precio de alquiler mensual *</label>

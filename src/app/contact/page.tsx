  ...
  return (
    <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mb-12 text-center">
        <h1 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">Contacto</h1>
      ...
      <div className="mt-16">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h3 className="mb-3 text-lg font-semibold">¿Cómo puedo vender mi propiedad con InmoEstate?</h3>
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h3 className="mb-3 text-lg font-semibold">¿Cuánto tiempo lleva vender una propiedad?</h3>
            <p className="text-gray-700">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h3 className="mb-3 text-lg font-semibold">¿Qué documentos necesito para vender mi propiedad?</h3>
            <p className="text-gray-700">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md">
            <h3 className="mb-3 text-lg font-semibold">¿Ofrecen financiamiento para la compra?</h3>
            <p className="text-gray-700">
